...
public class MyHashMapTest {
    ...
    public void checkIfContainsKey() {
        ...
        Assert.assertTrue("Test failed! The size isn't correct. Expected 3 but was "
                + myHashMap.getSize(), myHashMap.containsKey(firstCar));
        Assert.assertFalse("Test failed! The size isn't correct. Expected 3 but was "
                + myHashMap.getSize(), myHashMap.containsKey(null));
    }
